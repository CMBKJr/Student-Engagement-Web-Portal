    ...
    <div className="admin-content-page">
      <div className="grid">
        <div className="toolbar">
          ...
          <button className="ok" onClick={() => alert("Issue selected…")}>
            Issue Selected
          </button>
        </div>
        ...
        <section className="grid cols-2">
          <div className="panel card">
            <div className="toolbar">
              ...
              <label>
                Template<select className="input"></select>
              </label>
              <label>
                Signature<select className="input"></select>
              </label>
              <label>
                Delivery
                <select className="input">
          ...
          <div className="panel card">
            <div className="toolbar">
              ...
              <label>
                Badge<select className="input"></select>
              </label>
              <label>
                Issue as Open Badge (baked){" "}
                <input type="checkbox" defaultChecked />
              </label>
            </div>
          </div>
